...
MEMORY
{
    /* This project uses the STM32 factory bootloader. Therefore 
	the software can be programmed starting on 0x08000000 */
     
	FLASH_VECT (rx)  : ORIGIN = 0x08000000, LENGTH = 16K
    FLASH_CONST (rx) : ORIGIN = 0x08004000, LENGTH = 16K
    FLASH_TEXT (rx)  : ORIGIN = 0x08008000, LENGTH = 224K
